...
DROP TABLE IF EXISTS vote_participation;
...
(
    id         CHAR(36)      NOT NULL COMMENT '모임 ID',
...
CREATE TABLE event
(
    id                    CHAR(36)        NOT NULL COMMENT '이벤트 ID',
...
CREATE TABLE member
(
    id         CHAR(36)     NOT NULL COMMENT '모임원 ID',
    meeting_id CHAR(36)     NOT NULL COMMENT '모임 ID',
...
(
    id         CHAR(36)     NOT NULL COMMENT '활동 ID',
    meeting_id CHAR(36)     NOT NULL COMMENT '모임 ID',
...
CREATE TABLE ticket
(
    id         CHAR(36)     NOT NULL COMMENT '응모권 ID',
    user_id    CHAR(36)     NOT NULL COMMENT '사용자 ID',
...
(
    id         CHAR(36)     NOT NULL COMMENT '이벤트 참여 ID',
    event_id   CHAR(36)     NOT NULL COMMENT '이벤트 ID',
    user_id    CHAR(36)     NOT NULL COMMENT '사용자 ID',
...
(
    id           CHAR(36)        NOT NULL COMMENT '지출 ID',
    activity_id  CHAR(36)        NOT NULL COMMENT '활동 ID',
    creator_id   CHAR(36)        NOT NULL COMMENT '작성자 ID',
...
(
    id          CHAR(36)     NOT NULL COMMENT '응모권 이력 ID',
    ticket_id   CHAR(36)     NOT NULL COMMENT '응모권 ID',
    meeting_id  CHAR(36)     NOT NULL COMMENT '모임 ID (지급 시에만 사용)',
...
(
    id                     CHAR(36)        NOT NULL COMMENT '결제 ID',
    event_participation_id CHAR(36)        NOT NULL COMMENT '이벤트 참여 ID',
...
(
    id         CHAR(36)     NOT NULL COMMENT '댓글 ID',
    expense_id CHAR(36)     NOT NULL COMMENT '지출 ID',
...
(
    id         CHAR(36)     NOT NULL COMMENT '반응 ID',
    expense_id CHAR(36)     NOT NULL COMMENT '지출 ID',
    reactor_id CHAR(36)     NOT NULL COMMENT '반응자 ID',
...
CREATE TABLE vote
(
    id         CHAR(36)        NOT NULL COMMENT '투표 ID',
    meeting_id CHAR(36)        NOT NULL COMMENT '모임 ID',
    creator_id CHAR(36)        NOT NULL COMMENT '생성자 ID',
...
(
    id         CHAR(36)     NOT NULL COMMENT '투표 참여 ID',
    vote_id    CHAR(36)     NOT NULL COMMENT '투표 ID',
    voter_id   CHAR(36)     NOT NULL COMMENT '투표자 ID',
...
(
    id          CHAR(36)      NOT NULL COMMENT '알림 ID',
